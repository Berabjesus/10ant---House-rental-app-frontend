    ...
    <section className={`vh_100 pt-xl-5 ps-md-5 ${style.section}`}>
      ...
      <div className='d-flex flex-column px-5 pt-5 col-12 col-md-6'>
        <div className="pb-2 mb-2 ">
          <h2 className={`display-1 p-0 m-0 font_logo text-black border-bottom border-dark w-auto ${style.logo}`}>10Ant</h2>
        </div>
        <div className={`font_os text-black fw-bolder pt-2 ${style.description}`}>
